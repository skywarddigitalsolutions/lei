  ...
  return (
    <>
      ...
      <div className='min-h-screen bg-gris py-24 px-4'>
        <h4 className="text-5xl md:text-7xl lg:text-9xl font-bold text-left mb-2 lg:mb-4 text-yellow-200 tracking-wider break-words">Travis</h4>
        <h5 className='text-xl md:text-2xl lg:text-4xl text-yellow-200 mb-6 lg:mb-12'>Asistencia en estilismo y producción</h5>
        <p className='text-lg md:text-xl lg:text-xl text-grisclaro mb-12 lg:mb-40'>Plasmando el concepto de sin género</p>
