...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[290vh] lg:h-[300vh] bg-gris pt-40 lg:pt-24 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
