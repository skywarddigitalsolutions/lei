...
export default function Contacto() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex flex-col md:flex-row justify-center items-center bg-gris py-12 px-4">
                
                {/* Imagen izquierda */}
                <div className="hidden md:block md:w-1/3 lg:w-1/3 p-4">
                    <img
                ...
                <div className="w-full md:w-1/3 lg:w-auto flex flex-col items-center text-center space-y-6 px-4">
                    ...
                    <div className="flex flex-col space-y-4 w-full px-8">
                        <Link
                            href="https://wa.me/1138717447?text=Hola%20Leila,%20trabajemos%20juntos"
                            className="flex items-center justify-center bg-yellow-200 text-gray-800 font-semibold rounded-lg py-3 w-full transition duration-300 hover:bg-yellow-300 shadow-lg"
                        >
